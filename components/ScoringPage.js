...
export default function ScoringPage({ team, displayName }) {
    ...
    return (
        <>
            ...
            <Grid>
                <Typography variant="h2" textAlign="center" gutterBottom fontFamily="Bank Gothic">{displayName} Scoring</Typography>
                <ButtonGroup
                    size="large"
                ...
                <Typography variant="h4" textAlign="center" fontFamily="Bank Gothic">Points: {points}</Typography>
            </Grid>
        </>
    );
}